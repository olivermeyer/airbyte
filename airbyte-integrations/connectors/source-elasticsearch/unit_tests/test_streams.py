...
import pytest
from source_elasticsearch.source import ElasticsearchStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ElasticsearchStream, "path", "v0/example_endpoint")
    mocker.patch.object(ElasticsearchStream, "primary_key", "test_primary_key")
    mocker.patch.object(ElasticsearchStream, "__abstractmethods__", set())
